...
In this project, I validate the input form and allows the user to send an email after validation is successful. Also, user will see spinner in case loading of application takes time.
